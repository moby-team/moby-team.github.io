    ...
    return type && type === 'SCENE_ACTION' ? (
        <div style={{ padding: "10px 0"}}>
            <div className="text-left">
                <span className={lato.className} style={{fontSize:"16pt", color:"white"}}>{text}</span>
            </div>
        </div>
    ) : (
        <div style={{ margin: "1%", padding: "10px 0"}}>
            <div className="text-center">
                <span className={lato.className} style={{fontSize:"16pt", color:"white"}}>{name}</span>
            </div> 
            <div className="text-left" style={{marginLeft:"20%", marginRight:"20%"}}>
                <span id={`dialogue${keyProp}`} className={lato.className} style={{color:"white", fontSize:"16pt"}}>{text}</span>
            </div>
        </div>
    )
}
